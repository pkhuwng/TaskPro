                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(getActivity(), new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                        ...
                        if (selectedDate.before(currentDate)) {
                            ...
                            AddTaskFragment.this.month = monthOfYear;
                            AddTaskFragment.this.day = dayOfMonth;
            ...
            public void onClick(View v) {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(getActivity(), new TimePickerDialog.OnTimeSetListener() {
                    ...
                    public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                        ...
                        AddTaskFragment.this.hour = hourOfDay;
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(title) || TextUtils.isEmpty(date) || TextUtils.isEmpty(time)) {
                    ...
                    if (lineCount > 3) {
                        ...
                        selectedDateTime.set(AddTaskFragment.this.year, AddTaskFragment.this.month, AddTaskFragment.this.day, AddTaskFragment.this.hour, AddTaskFragment.this.minute);
