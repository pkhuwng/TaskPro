...
public class AccountFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ImageView imageEditEmail = rootView.findViewById(R.id.imageEditEmail);


        passwordArrow.setOnClickListener(this);
        passwordLayout.setOnClickListener(this);

        imageEditEmail.setOnClickListener(this);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.passwordChange || v.getId() == R.id.imageChangePasswordArrow) {
        ...
        } else if (v.getId() == R.id.imageEditEmail) {
            Intent editEmailIntent = new Intent(requireContext(), EmailEditActivity.class);
