...
public class EditTaskFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (args != null) {
            String taskKey = args.getString("taskKey");
            ...
            // Use these details to populate your UI elements
            TextInputEditText titleEditText = rootView.findViewById(R.id.titleEditText2);
            TextInputEditText contentEditText = rootView.findViewById(R.id.contentEditText2);
            TextView dateTextView = rootView.findViewById(R.id.dateTextView2);
            TextView timeTextView = rootView.findViewById(R.id.timeTextView2);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        // Find the views
        TextInputEditText titleEditText = view.findViewById(R.id.titleEditText2);
        TextView dateTextView = view.findViewById(R.id.dateTextView2);
        ImageView calendarImageView = view.findViewById(R.id.calendarImageView2);
        TextView timeTextView = view.findViewById(R.id.timeTextView2);
        ImageView clockImageView = view.findViewById(R.id.clockImageView2);
        TextInputEditText contentEditText = view.findViewById(R.id.contentEditText2);
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(getActivity(), new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                        ...
                        if (selectedDate.before(currentDate)) {
                            ...
                            Toast.makeText(getActivity(), R.string.toast_please_select_a_date_in_the_future, Toast.LENGTH_SHORT).show();
                        } else {
                            // Store the selected date in variables
                            EditTaskFragment.this.year = year;
                            EditTaskFragment.this.month = monthOfYear;
                            EditTaskFragment.this.day = dayOfMonth;
            ...
            public void onClick(View v) {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(getActivity(), new TimePickerDialog.OnTimeSetListener() {
                    ...
                    public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                        ...
                        EditTaskFragment.this.hour = hourOfDay;
                        EditTaskFragment.this.minute = minute;
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(title) || TextUtils.isEmpty(date) || TextUtils.isEmpty(time)) {
                    ...
                    Toast.makeText(getActivity(), R.string.toast_please_enter_both_title_date_and_time, Toast.LENGTH_SHORT).show();
                } else {
                    // Check if content exceeds the maximum number of lines
                    int lineCount = contentEditText.getLineCount();
                    if (lineCount > 3) {
                        // Show an error message to the user
                        Toast.makeText(getActivity(), R.string.toast_content_should_not_exceed_3_lines_30_words, Toast.LENGTH_SHORT).show();
                    }else{
                        // Get the current time
                        final Calendar currentTime = Calendar.getInstance();
                        ...
                        selectedDateTime.set(EditTaskFragment.this.year, EditTaskFragment.this.month, EditTaskFragment.this.day, EditTaskFragment.this.hour, EditTaskFragment.this.minute);
                        ...
                        if (timeDifferenceInMinutes < 6) {
                            // Show an error message to the user
                            Toast.makeText(getActivity(), R.string.toast_please_select_a_time_at_least_six_minutes_later, Toast.LENGTH_SHORT).show();
                        } else {
    ...
    private void saveTaskToFirebase(String title, String date, String time, String content) {
        ...
        if (currentUser == null) {
            ...
            Toast.makeText(getActivity(), R.string.state_not_logged_in, Toast.LENGTH_SHORT).show();
        ...
        String taskId = this.currEditTaskID;
            ...
            userTasksRef.child(taskId).setValue(task)
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            ...
                            Toast.makeText(getActivity(), R.string.toast_task_saved_successfully, Toast.LENGTH_SHORT).show();
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            ...
                            Toast.makeText(getActivity(), getString(R.string.toast_failed_to_save_task) + e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });
        } else {
            // No internet connection, save the task locally and redirect to the homepage
            userTasksRef.child(taskId).setValue(task);
            Toast.makeText(getActivity(), R.string.toast_task_saved_locally_no_internet_connection, Toast.LENGTH_SHORT).show();
            navigateToHomeFragment();
        }
        // For the reminder...
